...
public class MainActivityTest {
    @Rule
    public ActivityScenarioRule<MainActivity> r=
            new ActivityScenarioRule<>(MainActivity.class);
    @Test
    public void a(){
        onView(withId(R.id.field_nameEntry)).check(matches(withEffectiveVisibility(INVISIBLE)));
        onView(withId(R.id.button_add)).perform(click());
        onView(withId(R.id.field_nameEntry)).check(matches(isDisplayed()));
